"use strict";const t=require("electron");function a(e=["complete","interactive"]){return new Promise(n=>{e.includes(document.readyState)?n(!0):document.addEventListener("readystatechange",()=>{e.includes(document.readyState)&&n(!0)})})}const r={append(e,n){Array.from(e.children).find(i=>i===n)||e.appendChild(n)},remove(e,n){Array.from(e.children).find(i=>i===n)&&e.removeChild(n)}};function s(){const e="loaders-css__square-spin",n=`
