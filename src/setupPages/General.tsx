  ...
  return (
    <div>
      <div className="setup-setting">
        ...
        <div className="setup-setting-description">
          Click the 'X' in the top-right corner when you're ready to fuse. There will be a tooltip if everything is setup correctly!
        </div>
      </div>
      <div className="setup-setting">
        ...
        {!isChanges && ready && <div className="ready-to-go">Ready to go!</div>}
